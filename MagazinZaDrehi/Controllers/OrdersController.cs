...
namespace MagazinZaDrehi.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,ArticulId,Quantity,OrderOn")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,ArticulId,Quantity,OrderOn")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
